package se.callista.microservices.composite.product.security;
...
import se.callista.microservices.composite.product.oauth2.util.OAuth2AuthoritiesExtractor;
...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices {
	...
	private OAuth2Authentication extractAuthentication(Map<String, Object> map) {
		...
		System.out.println("composite user authority-----"+authorities.get(1).getAuthority());
	...
	private OAuth2Request getRequest(Map<String, Object> map) {
		...
		List<GrantedAuthority> authorities = this.authoritiesExtractor
				.extractAuthorities(request);
		
		System.out.println("composite client-----"+authorities.get(0).getAuthority());
